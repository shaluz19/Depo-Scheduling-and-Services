<%@ page language="VB" autoeventwireup="false" inherits="trip, App_Web_4s0saedw" %>
		...
		<div class="container-contact100">
			...
			<div class="wrap-contact100">
                ...
                <div>
					...
					<asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="Enter Schedule ID" ControlToValidate="sid" ForeColor="Red"></asp:RequiredFieldValidator>
                   <asp:Button ID="Button6" class="contact100-form-btn" runat="server" Text="Get Schedule Details" CausesValidation="False" />
                         </div>
					...
					<asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ErrorMessage="Select an Date" ControlToValidate="sdate" ForeColor="Red" Display="Dynamic" SetFocusOnError="True"></asp:RequiredFieldValidator>
                    </div>
                    
                    <div class="wrap-input100 validate-input" data-validate = "Name is required">
					<asp:Label ID="Label3" runat="server" Text="Driver ID"></asp:Label>
                     <asp:TextBox ID="did" cssClass ="input100" runat="server"> </asp:TextBox>   
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ErrorMessage="Select Driver ID" ControlToValidate="did" ForeColor="Red"></asp:RequiredFieldValidator>
                    </div>
                    
                <div><asp:Button ID="driver" class="contact100-form-btn" runat="server" Text="Get Driver Name" CausesValidation="False" /></div>
                    <div class="wrap-input100 validate-input" data-validate = "Name is required">
                    ...
                    <div class="wrap-input100 validate-input" data-validate = "Name is required">
					<asp:Label ID="Label5" runat="server" Text="Conductor ID"></asp:Label>
                         <asp:TextBox ID="cid" cssClass ="input100"  runat="server"></asp:TextBox>
					<asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ErrorMessage="Select Conductor ID" ControlToValidate="cid" ForeColor="Red"></asp:RequiredFieldValidator>
                    </div>
                    <div><asp:Button ID="conductor" class="contact100-form-btn" runat="server" Text="Get Conductor Name" CausesValidation="False" /></div>
                    
                    <div class="wrap-input100 validate-input" data-validate = "Name is required">
						<asp:Label ID="Label6" runat="server" Text="Conductor Name"></asp:Label>
                         <asp:TextBox ID="cname" cssClass ="input100"   runat="server"></asp:TextBox>
					</div>
                    
                    <div class="wrap-input100 validate-input" data-validate = "Name is required">
					<asp:Label ID="Label7" runat="server" Text="Route Number"></asp:Label>
                        ...
                        <asp:SqlDataSource runat="server" ID="SqlDataSource1" ConnectionString='<%$ ConnectionStrings:depoConnectionString %>' SelectCommand="SELECT [routeno] FROM [routedetails]"></asp:SqlDataSource>
                    </div>
                    
                    <div><asp:Button ID="Button5" class="contact100-form-btn" runat="server" Text="Get Route Details" CausesValidation="False" /></div>
				...
				<%--		<input class="input100" type="text" name="name" placeholder="Name">
                    ...
                    <div class="wrap-input100 validate-input" data-validate = "Name is required">
                        ...
                        <asp:SqlDataSource runat="server" ID="SqlDataSource2" ConnectionString='<%$ ConnectionStrings:depoConnectionString %>' SelectCommand="SELECT [vno] FROM [vehicledetails]"></asp:SqlDataSource>
                    </div>
					...
					<asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" ErrorMessage="Enter number of Trips" ControlToValidate="tottrip" ForeColor="Red"></asp:RequiredFieldValidator>
                    </div>
                <div class="wrap-input100 validate-input" data-validate = "Valid email is required: ex@abc.xyz">
						<%--<input class="input100" type="text" name="email" placeholder="Email">
						<span class="focus-input100"></span>
					...
					<div class="container-contact100-form-btn">
                       ...
                       <div>                        
                      <asp:Button ID="Button2" class="contact100-form-btn" runat="server" Text="Modify details" CausesValidation="False" />  
					</div>
                        <div>
                     <asp:Button ID="Button3" class="contact100-form-btn" runat="server" Text="Delete Schedule" CausesValidation="False" />  
                </div>
                     <div>   
                     <asp:Button ID="Button4" class="contact100-form-btn" runat="server" Text="Back" CausesValidation="False" PostBackUrl="~/ahome.aspx" />  
                </div>
        </div>
        </div>
                    </div>
